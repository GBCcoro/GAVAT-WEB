                  ...
                  <tr key={pedido.id}>
                    ...
                    <td>
                      <div className="btn-group btn-group-sm">
                        <button className="btn-action view" onClick={() => handleVerDetalle(pedido.id)} title="Ver detalle"><i className="bi bi-eye"></i></button>
                ...
                <table className="table table-sm">
                  ...
                  <tbody>
                    {pedidoSeleccionado.DetallePedidos?.map((detalle, index) => (
                      <tr key={index}><td>{detalle.Producto?.nombre || 'Producto no disponible'}</td><td>{detalle.cantidad}</td><td>{formatearPrecio(detalle.precioUnitario)}</td><td><strong>{formatearPrecio(detalle.subtotal)}</strong></td></tr>
                    ))}
                  </tbody>
